    ...
    <>
      <div>
        ...
        <div className="flex gap-2 my-5">
          <div className="bg-white rounded-lg border flex flex-col items-centre shadow w-1/2 py-5 px-2">
            {/* Top row: text + number */}
        ...
        <div className="flex gap-2 my-5">
          <div className="bg-white rounded-lg border flex flex-col items-centre shadow w-1/2 py-5">
          ...
          <table className="w-full border border-gray-300 text-left ">
            <thead>
              <tr className="bg-gray-100">
                <td className="border-b px-4 py-3 text-[14px]">Date & Time</td>
                <td className="border-b px-4 py-3 text-[14px]">Transaction Type</td>
                <td className="border-b px-4 py-3 text-[14px]">Amount</td>
                <td className="border-b px-4 py-3 text-[14px]">Reference Number</td>
              </tr>
            </thead>
            <tbody >
              <tr>
                <td className="border-b px-4 py-3 text-[14px]">2 Nov 2021 13:37</td>
                <td className="border-b px-4 py-3 text-[14px]">↗ Credit - Comission</td>
                <td className="border-b px-4 py-3 text-[14px]"><span className="text-green-400">+ 0.00 </span>USD</td>
                <td className="border-b px-4 py-3 text-[14px]">-</td>
              </tr>
              <tr>
                <td className="border-b px-4 py-3 text-[14px]">2 Nov 2021 13:37</td>
                <td className="border-b px-4 py-3 text-[14px]">↗ Credit - Comission</td>
