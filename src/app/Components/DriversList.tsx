...
export default function DriversList() {
  ...
  return (
    <div className=" bg-gray-50 px-5">
      ...
      <div className="bg-white rounded-lg border  w-full max-w-full">
          ...
          <tbody>
            {drivers.map((driver, index) => (
              <tr key={index} className="border-b last:border-b-0 hover:bg-gray-50">
                ...
                <td className="px-3 py-4 text-sm text-blue-600">{driver.phone}</td>
                <td className="px-3 py-4">
                ...
                <td className="px-3 py-4 text-sm text-gray-700">{driver.wallet}</td>
                <td className="px-3 py-4 text-sm text-gray-700">{driver.orders}</td>
              </tr>
            ))}
          </tbody>
        </table>
