        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className={`text-base pb-2 ${
              activeTab === "pending" ? "text-blue-600 border-b-2 border-blue-600 font-medium" : "text-gray-500"
            }`}
          >
            Pending
          </button>
          <button
            ...
            className={`text-base pb-2 ${
              activeTab === "ontrip" ? "text-blue-600 border-b-2 border-blue-600 font-medium" : "text-gray-500"
            }`}
          >
            On Trip
          </button>
          <button
            ...
            className={`text-base pb-2 ${
              activeTab === "scheduled" ? "text-blue-600 border-b-2 border-blue-600 font-medium" : "text-gray-500"
            }`}
          >
            Scheduled
          </button>
